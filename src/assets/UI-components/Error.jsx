...
const Error = () => {
	...
	return (
		<div className="fixed top-1 right-1 md:top-2 md:right-2 py-3 px-3 shadow-custom_4 rounded-md flex items-center gap-x-4 bg-white z-40 w-52 xs:w-72 md:w-80">
